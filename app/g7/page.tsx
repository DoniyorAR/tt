 ...
 * - Clicking map opens fullscreen lightbox with zoom/pan (ImageLightbox component)
 *
      ...
      {tab === "carbon" && (
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            {/* Reason image / explanation + quick links to carbon subpages */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex gap-2 flex-wrap">
                    ...
                    <a href="/g7/reasons.png" download className="rounded-lg border border-slate-300 px-3 py-1 text-sm">
                      Download PNG
                    </a>

                    {/* Links to new carbon pages */}
                    <Link href="/g7/carbon" className="rounded-lg border border-slate-300 px-3 py-1 text-sm">
                      Open Carbon hub
                    </Link>
                    <Link href="/g7/carbon/data-source" className="rounded-lg border border-slate-300 px-3 py-1 text-sm">
                      Data Source
                    </Link>
                    <Link href="/g7/carbon/results" className="rounded-lg border border-slate-300 px-3 py-1 text-sm">
                      Results
                    </Link>
                    <Link href="/g7/carbon/visualization" className="rounded-lg border border-slate-300 px-3 py-1 text-sm">
                      Visualization
                    </Link>
                    <Link href="/g7/carbon/explainability" className="rounded-lg border border-slate-300 px-3 py-1 text-sm">
                      Explainability
                    </Link>
                  </div>
                </div>
